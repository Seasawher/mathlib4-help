...
## \#clear_deprecations
Defined in: `Mathlib.Tactic.«command#clear_deprecations___Really»`
...
## \#deprecate
Defined in: `Mathlib.Tactic.DeprecateTo.deprecateTo`
...
Please consult [the reference manual](https://lean-lang.org/doc/reference/4.35.0-rc3/find/?domain=Verso.Genre.Manual.section&name=validating-proofs) to understand the significance of the output.
...
## deprecate
Defined in: `Mathlib.Tactic.DeprecateTo.oldStx`
...
## docs_to_verso
Defined in: `Lean.Parser.Command.docs_to_verso`
...
## initialize
Defined in: `Lean.Parser.Command.initialize`
...
## lemma
Defined in: `Batteries.Tactic.Lemma.lemmaCmd`
...
## prefix
Defined in: `Lean.Parser.Command.mixfix`
