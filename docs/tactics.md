...
## constructor!
Defined in: `Lean.Parser.Tactic.constructorBang`
...
This is an extensible tactic using [`macro_rules`](https://lean-lang.org/doc/reference/4.35.0-rc1/find/?domain=Verso.Genre.Manual.section&name=tactic-macro-extension).
...
See [the reference manual's chapter on `grind`](https://lean-lang.org/doc/reference/4.35.0-rc1/find/?domain=Verso.Genre.Manual.section&name=grind-tactic) for more information.
...
## rwa
Defined in: `Lean.Parser.Tactic.rwaAtLegacyLocation`
...
## rwa
Defined in: `Lean.Parser.Tactic.rwaAt`
...
## rwa
Defined in: `Lean.Parser.Tactic.rwa`
