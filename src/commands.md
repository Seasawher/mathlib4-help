syntax "#adaptation_note"... [adaptationNoteCmd]
...
syntax "#aesop_rules"... [Aesop.Frontend.Parser.«command#aesop_rules»]

syntax "#aesop_stats"... [Aesop.Frontend.Parser.«command#aesop_stats_»]

syntax "#allow_unused_tactic"... [Mathlib.Linter.UnusedTactic.«command#allow_unused_tactic_»]
...
syntax "#check"... [Lean.Parser.Command.check]
...
syntax "#discr_tree_key"... [Lean.Parser.discrTreeKeyCmd]
...
syntax "#discr_tree_simp_key"... [Lean.Parser.discrTreeSimpKeyCmd]
  `#discr_tree_key  t` prints the discrimination tree keys for a term `t` (or, if it is a single identifier, the type of that constant).
  It uses the default configuration for generating keys.
...
syntax "#guard_msgs"... [Lean.guardMsgsCmd]
...
syntax "#instances"... [Batteries.Tactic.Instances.instancesCmd]
...
syntax "#instances"... [Batteries.Tactic.Instances.«command#instances__:_»]
  `#instances term` prints all the instances for the given class.
  For example, `#instances Add _` gives all `Add` instances, and `#instances Add Nat` gives the
  `Nat` instance. The `term` can be any type that can appear in `[...]` binders.
...
syntax "#long_instances"... [«command#long_instances_»]
...
syntax "#min_imports in"... [Mathlib.Command.MinImports.minImpsStx]
...
syntax "#min_imports in"... [Mathlib.Command.MinImports.«command#min_imports_in_»]
  `#min_imports in cmd` scans the syntax `cmd` and the declaration obtained by elaborating `cmd`
  to find a collection of minimal imports that should be sufficient for `cmd` to work.
...
syntax "#print"... [Batteries.Tactic.printPrefix]
...
syntax "#print"... [Lean.Parser.Command.printAxioms]

syntax "#print"... [Lean.Parser.Command.printTacTags]
  Displays all available tactic tags, with documentation.

syntax "#print"... [Lean.Parser.Command.printEqns]

syntax "#print"... [Batteries.Tactic.«command#printDependents___»]
...
syntax "#print"... [Lean.Parser.Command.print]
...
syntax "#reset_min_imports"... [Mathlib.Linter.«command#reset_min_imports»]
...
syntax "#show_unused"... [Batteries.Tactic.ShowUnused.«command#show_unused___»]
...
syntax "#synth"... [Lean.Parser.Command.synth]

syntax "#test"... [SlimCheck.«command#test_»]

syntax "#time"... [timeCmd]

syntax "#unfold?"... [Mathlib.Tactic.InteractiveUnfold.unfoldCommand]
  `#unfold? e` gives all unfolds of `e`.
  In tactic mode, use `unfold?` instead.

syntax "#where"... [Batteries.Tactic.Where.«command#where»]
...
syntax "add_aesop_rules"... [Aesop.Frontend.Parser.command_Add_aesop_rules_]

syntax "add_decl_doc"... [Lean.Parser.Command.addDocString]
...
syntax "alias"... [Batteries.Tactic.Alias.alias]
...
syntax "alias"... [Batteries.Tactic.Alias.aliasLR]
  The command `alias name := target` creates a synonym of `target` with the given name.
...
syntax "assert_no_sorry"... [commandAssert_no_sorry_]
...
syntax "assert_not_imported"... [commandAssert_not_imported_]
...
syntax "attribute"... [Lean.Parser.Command.attribute]

syntax "binder_predicate"... [Lean.Parser.Command.binderPredicate]
  Declares a binder predicate.  For example:
  ```
  binder_predicate x " > " y:term => `($x > $y)
  ```

syntax "builtin_dsimproc"... [Lean.Parser.«command__Builtin_dsimproc__[_]_(_):=_»]
  A builtin defeq simplification procedure.

syntax "builtin_dsimproc_decl"... [Lean.Parser.«command_Builtin_dsimproc_decl_(_):=_»]
  A builtin defeq simplification procedure declaration.

syntax "builtin_simproc"... [Lean.Parser.«command__Builtin_simproc__[_]_(_):=_»]
  A builtin simplification procedure.

syntax "builtin_simproc_decl"... [Lean.Parser.«command_Builtin_simproc_decl_(_):=_»]
...
syntax "class"... [Lean.Parser.Command.classAbbrev]
  Expands
  ```
...
syntax "count_heartbeats!"... [Mathlib.CountHeartbeats.commandCount_heartbeats!_In__]
...
syntax "declare_bitwise_uint_theorems"... [commandDeclare_bitwise_uint_theorems_]

syntax "declare_config_elab"... [Lean.Elab.Tactic.configElab]

syntax "declare_simp_like_tactic"... [Lean.Parser.Tactic.declareSimpLikeTactic]

syntax "declare_syntax_cat"... [Lean.Parser.Command.syntaxCat]

syntax "declare_uint_simprocs"... [commandDeclare_uint_simprocs_]

syntax "declare_uint_theorems"... [commandDeclare_uint_theorems_]

syntax "deprecate to"... [Mathlib.Tactic.DeprecateMe.commandDeprecate_to____]
  Writing
  ```lean
...
syntax "deriving"... [Lean.Parser.Command.deriving]

syntax "dsimproc"... [Lean.Parser.«command__Dsimproc__[_]_(_):=_»]
  Similar to `simproc`, but resulting expression must be definitionally equal to the input one.

syntax "dsimproc_decl"... [Lean.Parser.«command_Dsimproc_decl_(_):=_»]
...
syntax "elab"... [Lean.Parser.Command.elab]

syntax "elab_rules"... [Lean.Parser.Command.elab_rules]

syntax "elab_stx_quot"... [Lean.Elab.Term.Quotation.commandElab_stx_quot_]

syntax "end"... [Lean.Parser.Command.end]
...
syntax "export"... [Lean.Parser.Command.export]
...
syntax "gen_injective_theorems%"... [Lean.Parser.Command.genInjectiveTheorems]
...
syntax "import"... [Lean.Parser.Command.import]

syntax "in"... [Lean.Parser.Command.in]

syntax "include"... [Lean.Parser.Command.include]
...
syntax "init_quot"... [Lean.Parser.Command.init_quot]
...
syntax "irreducible_def"... [Lean.Elab.Command.command_Irreducible_def____]
...
syntax "macro"... [Lean.Parser.Command.macro]

syntax "macro_rules"... [Lean.Parser.Command.macro_rules]
...
syntax "mutual"... [Lean.Parser.Command.mutual]

syntax "namespace"... [Lean.Parser.Command.namespace]
...
syntax "noncomputable"... [Lean.Parser.Command.noncomputableSection]
...
syntax "notation"... [Lean.Parser.Command.notation]

syntax "notation3"... [Mathlib.Notation3.notation3]
...
syntax "open"... [Lean.Parser.Command.open]
...
syntax "proof_wanted"... [proof_wanted]
...
syntax "register_builtin_option"... [Lean.Option.registerBuiltinOption]
...
syntax "register_label_attr"... [Lean.Parser.Command.registerLabelAttr]
...
syntax "register_option"... [Lean.Option.registerOption]

syntax "register_simp_attr"... [Lean.Parser.Command.registerSimpAttr]

syntax "register_tactic_tag"... [Lean.Parser.Command.register_tactic_tag]
...
syntax "scoped"... [Mathlib.Tactic.scopedNS]
...
syntax "seal"... [Lean.Parser.commandSeal__]
...
syntax "section"... [Lean.Parser.Command.section]
...
syntax "set_option"... [Lean.Parser.Command.set_option]
...
syntax "simproc"... [Lean.Parser.«command__Simproc__[_]_(_):=_»]
...
syntax "simproc_decl"... [Lean.Parser.«command_Simproc_decl_(_):=_»]
...
syntax "syntax"... [Lean.Parser.Command.syntax]

syntax "syntax"... [Lean.Parser.Command.syntaxAbbrev]

syntax "tactic_extension"... [Lean.Parser.Command.tactic_extension]
...
syntax "unif_hint"... [Lean.«command__Unif_hint____Where_|_-⊢_»]

syntax "universe"... [Lean.Parser.Command.universe]
...
syntax "unseal"... [Lean.Parser.commandUnseal__]
...
syntax "variable"... [Lean.Parser.Command.variable]
